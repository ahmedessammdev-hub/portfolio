...
export default function Linkedin({ color = "currentColor", hoverColor = "currentColor" }) {
  ...
  return (
    <svg
      ...
      style={{ cursor: hoverColor ? "pointer" : "default" }}>
      <path d="M5.39825 7.79682C6.70735 7.79682 7.76858 6.73558 7.76858 5.42649C7.76858 4.11739 6.70735 3.05615 5.39825 3.05615C4.08915 3.05615 3.02792 4.11739 3.02792 5.42649C3.02792 6.73558 4.08915 7.79682 5.39825 7.79682Z" />
